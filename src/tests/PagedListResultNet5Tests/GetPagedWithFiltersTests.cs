...
//  Author           : RzR
//  Created On       : 2023-11-13 22:19
// 
//  Last Modified By : RzR
//  Last Modified On : 2023-11-14 00:06
// ***********************************************************************
...
namespace PagedListResultNet5Tests
{
    ...
    public class GetPagedWithFiltersTests
    {
        ...
        public async Task GetPagedWithFilters_Request_MainFilter_Or_WithDependencies_Test()
        {
            ...
            var records = await query.GetPagedWithFiltersAsync(pageRequest, filterLink: FilterConditionType.Or);

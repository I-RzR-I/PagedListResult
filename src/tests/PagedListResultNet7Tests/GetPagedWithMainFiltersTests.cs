    ...
    public class GetPagedWithMainFiltersTests
    {
        ...
        public async Task GetPagedWithMainFiltersAsync_Request_Fields_Test()
        {
            var pageRequest = new PageRequestWithFilters
            {
                ...
                Filters = new List<DataFilter> { new DataFilter { FilterValue = new DataFilterValue { Values = new List<string> { "1" }, PropertyName = "id", Condition = FilterType.Equals } } }
            };
        ...
        public async Task GetPagedWithMainFiltersAsync_Page_1_PageSize_5_Test()
        {
            var pageRequest = new PageRequestWithFilters
            {
                ...
                {
                    new DataFilter { FilterApplyOrder = 0, FilterValue = new DataFilterValue { Condition = FilterType.Equals, PropertyName = "authorId", Values = new List<string> { "3" } } }
                }
            };
        ...
        public async Task GetPagedWithMainFiltersAsync_Page_1_PageSize_5_FilterTypeIsNull_Test()
        {
            var pageRequest = new PageRequestWithFilters
            {
                Page = 1, PageSize = 5, Filters = new List<DataFilter> { new DataFilter { FilterValue = new DataFilterValue { PropertyName = "modifiedOn", Condition = FilterType.IsNull } } }
            };
        ...
        public async Task GetPagedWithMainFiltersAsync_Page_1_PageSize_5_FilterTypeIsNull_And_AuthorIdIn_Test()
        {
            var pageRequest = new PageRequestWithFilters
            {
                ...
                Filters = new List<DataFilter>
                {
                    new DataFilter { FilterValue = new DataFilterValue { PropertyName = "modifiedOn", Condition = FilterType.IsNull }, FilterApplyOrder = 0 },
                    new DataFilter
                    {
                        FilterValue = new DataFilterValue { PropertyName = "authorId", Condition = FilterType.IsIn, Values = new List<string> { "3", "4" } }, FilterApplyOrder = 0
                    }
                }
            };
